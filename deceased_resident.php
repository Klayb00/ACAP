    ...
    <table class="table text-center">
        <thead>
            ...
            <?php
                ...
                $query = "SELECT * FROM residents_info WHERE status = 'Deceased'";
                $result = mysqli_query($conn, $query);
            ...
            <tr>
                            ...
                            <td>
                                <?php
                                if (!empty($row['image'])) {
                                    echo '<img src="uploaded_img/' . $row['image'] . '" alt="Resident Image" class="img-thumbnail" style="width: 100px; height: 100px;">';
                                } else {
                                    echo '<img src="images/default-avatar.png" alt="Default Avatar" class="img-thumbnail" style="width: 100px; height: 100px;">';
                                }
                                ?>
                            </td>
                        </tr>
                    ...
                    echo '<tr><td colspan="7" class="text-center">No deceased residents found.</td></tr>';
                }
                ?>
    </tr>
</tbody>
