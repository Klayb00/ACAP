...
<div class="wrapper">
    ...
    <h1>Foods and Utilities Dispense</h1>
</div>
<div class="medsbg">
    <div class="meds">
    ...
    <i class="fa-solid fa-magnifying-glass"></i>
            ...
            <?php 
            $sql = "SELECT * FROM foodutilities_out_records"; 
            ...
            <div class="table-responsive">
                ...
                <div class="bton">
                        <div class="bton-generate">
                            <a href="foodsutilitiesqr_code.php" class="generate"><i class="fa-solid fa-qrcode"></i>Generate Item Summary</a>
                            <a href="view_foods_summary.php" class="view-generate"><i class="fa-solid fa-box-open"></i>View Item Summary</a>
                            <a href="" class="print"><i class="fa-solid fa-rotate-right"></i>Reset</a>
                        </div>
