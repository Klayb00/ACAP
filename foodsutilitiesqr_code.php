...
$path = 'QR_images/Foods&Utilities/';
if (!is_dir($path)) {
...
$qr_url = "https://skfilucban.com/showfoods_items.php"; 

// Pangalan ng QR code image file
$qrcode_filename = $path . $month . "_food&utilities_out_summarize.png";
...
QRcode::png($qr_url, $qrcode_filename, QR_ECLEVEL_H, 4, 4);
    ...
    if(isset($_POST["saveQR"])){
        ...
        $checkQR = "SELECT * FROM foodqr WHERE month = '$monthUse'";
        $showCheckQR = mysqli_query($conn, $checkQR);
            ...
            if(mysqli_num_rows($showCheckQR) > 0){
                ...
                echo 'window.location.href = "foods&utilities_inventory.php"';
                echo '</script>';
            }else{

                $insertQR = "INSERT INTO foodqr VALUES ('', '$qrname', '$month', '$qrcode_filename')";
