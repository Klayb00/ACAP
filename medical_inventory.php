...
<div class="medicine-dashboard">
    <h1>Medical Assets Inventory</h1>
</div>
<div class="medsbg">
    <div class="meds">
        ...
        <h3 class="medicine-title">
          ...
          <a href="qrcode_medical_reader.php" class="btn btn-primary addmedsbtn"><b>Add Supply</b></a>
    ...
    <div class="contain">
        ...
        <thead>
            ...
            $count = 0;
                    ...
                    $out_items = intval($row["out_items"]);
                    $price = $row['price'];
    ...
    <tr>
        ...
        <td>
            <i class="fa-solid fa-pen-to-square"
                onclick="sendForm('<?php echo $row['medicaliD']; ?>', '<?php echo $row['item_name']; ?>', '<?php echo $row['expirations_date']; ?>', '<?php echo $row['donate']; ?>', '<?php echo $row['out_items']; ?>')"></i>
            <a class="dlt_med" href="delete_medical.php?id=<?php echo $row['medicaliD']; ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fa-solid fa-trash"></i></a>
        </td>
                            <?php } ?>
                        </tr>
                        <?php 
...
<script>
     function sendForm(id,name,m_expiredDatem_donate,m_outitems,){
                                ...
                                document.getElementById("medical_expired").value = m_expiredDate;
                                document.getElementById("medical_donate").value = m_donate;
                                document.getElementById("medical_outitems").value = m_outitems;
...
<div class="medsform hidden" id="result">
    <form action="edit_medical.php" class="edit-form" method="POST">
        <h3 class="mb-3 text-center">Edit Supply</h3>
        <input type="text" name="medical_id" id="CurrrentId" value="<?php echo $medicaliD; ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="addstock" id="medical_addstock" value="0">
            <input type="hidden" name="bgnblnc" value="0">
        </div>

        <div class="mb-3">
            <label for="expirations_date" class="form-label"><b>Expiration Date</b></label>
            <input type="text" name="expirations_date"  id="medical_expired" value="<?php echo $row['expirations_date']; ?>">
        </div>

        <div class="mb-3">
            <label for="donate" class="form-label"><b>Donate</b></label>
            <input type="text" name="donate" id="medical_donate" value="0">
        </div>

        <div class="mb-3">
            <label for="out_items" class="form-label"><b>Out Items</b></label>
            <input type="text" name="out_items" id="medical_outitems" value="0">
        </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            $add_out_amount = "SELECT SUM(out_amount) AS total_out FROM `medical_inventory`";
        ...
        $add = "SELECT SUM(begin_amount) AS total_begin FROM `medical_inventory`";
        ...
        $add_use_items = "SELECT SUM(out_items) AS sum_items FROM `medical_inventory`";
        ...
        $expiredmeds = "SELECT COUNT(*) AS count_expired FROM `medical_inventory` WHERE expirations_date <= '$current_date'";
