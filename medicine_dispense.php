...
<div class="medsbg">
    ...
    <i class="fa-solid fa-magnifying-glass"></i>
            ...
            <?php 
            $sql = "SELECT * FROM medicine_out_records"; 
            ...
            <div class="table-responsive">
                ...
                <div class="bton">
                        <div class="bton-generate">
                            <a href="medicineqr_code.php" class="generate"><i class="fa-solid fa-qrcode"></i>Generate Item Summary</a>
                            <a href="view_meds_summary.php" class="view-generate"><i class="fa-solid fa-box-open"></i>View Item Summary</a>
                            <a href="print_data.php" class="print"><i class="fa-solid fa-print"></i>Print</a>
                        </div>
