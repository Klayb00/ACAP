...
$qrcode_filename = $path . $month . "_medicine_out_summarize.png";
...
QRcode::png($qr_url, $qrcode_filename, QR_ECLEVEL_H, 4, 4);
    ...
    if(isset($_POST["saveQR"])){
        ...
        $checkQR = "SELECT * FROM qrcode WHERE month = '$monthUse'";
        $showCheckQR = mysqli_query($conn, $checkQR);
            ...
            if(mysqli_num_rows($showCheckQR) > 0){
                ...
                echo 'window.location.href = "medicine_inventory.php"';
                echo '</script>';
            }else{

                $insertQR = "INSERT INTO qrcode VALUES ('', '$qrname', '$month', '$qrcode_filename')";
