...
$query = "SELECT * FROM foodutilities_out_records"; // Palitan ng iyong table name at column names
...
$selectMonth = "SELECT * FROM foodqr";
        ...
        <table>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): 
                    ...
                    ?>
                    <tr>
                        <td><?php echo $row['foodsutilitiesID']; ?></td>
